...
img2grd grav_27.1.img -R263/278/7/17 -GgravMAT.grd -T1 -I1 -E -S0.1 -V
# Step-4. Generate a color palette table from grid
gmt grd2cpt gravMAT.grd -Cseis > gravMAT.cpt
# Step-5. Generate gravity image with shading
gmt grdimage gravMAT.grd -I+a45+nt1 \
    -R263/278/7/17 -JY270/12/6.5i -CgravMAT.cpt -P -K > $ps
...
gmt psconvert Grav_MAT.ps -A0.5c -E720 -Tj -P -Z
