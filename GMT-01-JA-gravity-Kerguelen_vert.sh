...
gmt img2grd curv_27.1.img -R-40/150/-70/-10 -Ggravvert_Ker.grd -T1 -I1 -E -S0.1 -V

gdalinfo grav_Ker.grd -stats
# -166.277099609375,546.4031982421875
# Make color palette
gmt makecpt -Chaxby -V -T-40/40 > myocean.cpt
#makecpt --help

# Generate a file
ps=Gravity_Kgl_vert_JA.ps

gmt grdimage gravvert_Ker.grd -Cmyocean.cpt -R-25/-65/101/-10r -JA55/-50/7.5i -P -I+a15+ne0.75 -Xc -K > $ps
...
gmt psbasemap -R -J \
    ...
    -B+t"Vertical gravity gradient on Kerguelen Plateau" \
...
gmt psconvert Gravity_Kgl_vert_JA.ps -A1.7c -E720 -Tj -Z
