...
gmt img2grd grav_27.1.img -R-4/2/4/12 -Ggrav.grd -T1 -I1 -E -S0.1 -V
gmt grdcut grav.grd -R-4/2/4/12 -Ggh_grav.nc
gdalinfo -stats gh_grav.nc
# Minimum=-66.055, Maximum=92.523, Mean=7.462, StdDev=20.665
gmt makecpt -Cjet -T-100/100/1 > colors.cpt
# gmt makecpt --help

ps=Grav_GH.ps
# Make raster image
gmt grdimage gh_grav.nc -Ccolors.cpt -R-4/2/4/12 -JM5.0i -I+a15+ne0.75 -Xc -P -K > $ps
...
gmt psscale -Dg-4/3.4+w12.0c/0.15i+h+o0.3/0i+ml+e -R -J -Ccolors.cpt \
	...
	-Bg20f1a20+l"Color scale 'jet' (Dark to light blue, white, yellow and red [C=RGB] -183/278/1)" \
	-I0.2 -By+lmGal -O -K >> $ps
    
# Add isolines
gmt grdcontour gh_grav.nc -R -J -C5 -A10 -Wthinnest -O -K >> $ps
...
gmt psbasemap -R -J \
    ...
    -B+t"Free-air gravity anomaly for Ghana" -O -K >> $ps
...
gmt psconvert Grav_GH.ps -A0.5c -E720 -Tj -Z
