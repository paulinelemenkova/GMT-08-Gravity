...
gmt img2grd grav_27.1.img -R87.5/120/41.5/52.5 -Ggrav.grd -T1 -I1 -E -S0.1 -V
gmt grdcut grav.grd -R87.5/120/41.5/52.5 -Gmn_grav.nc
gdalinfo -stats mn_grav.nc
# Minimum=-233.017, Maximum=392.418, Mean=-16.450, StdDev=41.153
#gmt makecpt -Chaxby -T-234/393/1 > colors.cpt
gmt makecpt -Cjet -T-100/100/1 > pauline.cpt
# gmt makecpt --help
...
gmt grdimage mn_grav.nc -Cpauline.cpt -R87.5/120/41.5/52.5 -JM6.5i -I+a15+ne0.75 -t100 -Xc -P -K > $ps
    
# Add isolines
#gmt grdcontour mn_grav.nc -R -J -C1000 -A1000+f7p,26,darkbrown -Wthinner,darkbrown -O -K >> $ps
...
# Add raster image
gmt grdimage mn_grav.nc -Cpauline.cpt -R87.5/120/41.5/52.5 -JM6.5i -I+a15+ne0.75 -Xc -P -O -K >> $ps
# Add isolines
gmt grdcontour mn_grav.nc -R -J -C250 -Wthinnest,darkbrown -O -K >> $ps
# Add coastlines, borders, rivers
gmt pscoast -R -J \
...
gmt psscale -Dg87.2/39.6+w16.5c/0.15i+h+o0.3/0i+ml+e -R -J -Cpauline.cpt \
    ...
    -Bg20f2a20+l"Colormap: 'jet' (Dark to light blue, white, yellow and red [C=RGB] -100/100/1)" \
    -I0.2 -By+lm -O -K >> $ps
...
gmt psbasemap -R -J \
    ...
    -B+t"Free-air gravity anomaly for Mongolia" -O -K >> $ps
...
gmt psconvert Grav_MN.ps -A0.5c -E720 -Tj -Z
