...
# Mercator projection (here: Ryukyu Trench).
...
img2grd grav_27.1.img -R120/134/20/33 -GgravRT.grd -T1 -I1 -E -S0.1 -V
...
gmt grdimage gravRT.grd -I+a45+nt1 -R120/134/20/33 -JY127/27/6.5i -CgravRT.cpt -P -K > $ps
# Step-6. Add basemap: grid, title, costline
gmt pscoast -R -J -P \
	-V -W0.25p \
    -Df -B+t"Marine free-air gravity anomaly for the Ryukyu Trench area" \
	-Bxg3f2a2 -Byg3f2a2 \
    -O -K >> $ps
...
gmt psscale -R -J -CgravRT.cpt \
    -Dg117.5/20+w17.0c/0.5c+v+o0.7/0i+ml  \
...
gmt psconvert Grav_RT.ps -A0.2c -E720 -Tj -P -Z
